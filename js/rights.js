/**
 * TeleFlow - User Rights module (Management > User Rights)
 *
...
const RIGHTS_SCHEMA = {
    ...
    'UTILITY': [
        { name: 'Add/Edit Users', perms: ['View', 'Add', 'Edit', 'Delete'] },
...
const PAGE_RIGHTS_MAP = {
    ...
    'page-users': ['UTILITY', 'Add/Edit Users'],
    ...
    'page-rso-stock': ['RSO / SALESMAN', 'Issue Stock / Load'],
